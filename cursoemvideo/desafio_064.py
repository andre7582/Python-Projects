...
if con == 1:
    print('Você inseriu um número apenas com o seu valor igual a {}.'.format(som))
else:
    print('Você inseriu {} números e a soma entre eles é igual a {}.'.format(con, som))
print('.' * 99)
